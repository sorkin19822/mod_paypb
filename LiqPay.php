...
class LiqPay
{
    ...
    public function cnb_form($params)
    {
        ...
        return sprintf('
            <form method="POST" action="%s" accept-charset="utf-8" class="sendForm">
                %s
                %s
                <div class="agreement uk-margin-bottom uk-margin-top uk-text-bold uk-text-center"> <label><input type="checkbox" onclick="agrementpb()">  Я соглашаюсь</label><span> <a href="/doc/oferta.pdf" target="_blank">с условиями оферты</a></span></div>
                <input type="submit" src="//static.liqpay.ua/buttons/p1%s.radius.png" 
                class="submit uk-button uk-button-success"name="btn_text" value="Оплатить" disabled="true"/>
                <input type="button" onclick="cancel()" class="cancel uk-button uk-button-danger" name="btn_text" value="отменить">
            </form>
            ',
            $this->_checkout_url,
